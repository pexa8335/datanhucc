...
- `electrostatics_target_geometry_or_vector`: 15 rows; samples: LD391, LD204, LD044, LD050, LD208, LD035
...
- `U009` `electrostatics_relation_or_vector_gap`: 1 rows (electrostatics_force); samples: LD014
- `U010` `unknown_unsupported`: 1 rows (unknown); samples: CH102
