...
- `U005` `rlc_formula_family`: 4 rows (ac_rlc); samples: CH238; CH252; CH254; CH263
- `U006` `electrostatics_perpendicular_distance`: 3 rows (electrostatics_field); samples: LD353; DT042; DT058
- `U007` `rlc_power`: 2 rows (ac_rlc); samples: CH228; CH216
- `U008` `capacitor_target_or_relation`: 2 rows (capacitor); samples: CHLT015; CH083
- `U009` `rlc_current`: 1 rows (ac_rlc); samples: CH171
- `U010` `rlc_power_factor`: 1 rows (ac_rlc); samples: CH246
- `U011` `rlc_resonance`: 1 rows (ac_rlc); samples: CH141
- `U012` `capacitor_network`: 1 rows (capacitor); samples: TD391
